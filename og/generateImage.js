    ...
    >
      ...
      >
        ...
        >
          ...
          <img
            alt="Baljinnyamda"
            src="https://github.com/baljinnyamda.png"
            style={{
              height: 120,
              width: 120,
              borderRadius: "50%",
...
const montserratExtraBold = readFile(join(process.cwd(), "og/Montserrat-ExtraBold.ttf"));
const merriweatherRegular = readFile(join(process.cwd(), "og/Merriweather-Regular.ttf"));
const merriweatherItalic = readFile(join(process.cwd(), "og/Merriweather-Italic.ttf"));
